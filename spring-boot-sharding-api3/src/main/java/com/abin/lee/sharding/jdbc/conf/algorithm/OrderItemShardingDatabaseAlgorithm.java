 ...
 */
public class OrderItemShardingDatabaseAlgorithm implements ComplexKeysShardingAlgorithm {

    private final Logger log = LoggerFactory.getLogger(OrderItemShardingDatabaseAlgorithm.class);
